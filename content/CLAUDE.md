...
7. `wiki/my-video-stats.md` is generated by `scripts/refresh_stats.py`. Never edit it by hand. When analyzing which videos did better, read that table and connect the numbers to the techniques logged in my-videos.md (e.g. "the two best performers both opened with a question hook").
